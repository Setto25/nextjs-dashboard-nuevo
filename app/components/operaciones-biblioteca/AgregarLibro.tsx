...
/*
 este archivo de código permite a los usuarios subir Libros a una aplicación utilizando React y Next.js. Proporciona un formulario donde los usuarios pueden ingresar información como el título, tema, tipo de Libro (local ou online las interacciones del usuario, como la selección de archivos. Al seleccionar un archivo de Libro, se realizan validaciones para asegurarse de que cumple con los requisitos de tipo y tamaño. Cuando el formulario se envía, se crea un objeto FormData que se envía a un backend (/Libros/route.ts) a través de una solicitud POST. El componente también muestra notificaciones sobre el estado de la carga y proporciona instrucciones claras para el usuario sobre cómo subir Libros. Además, incluye un indicador de carga que se activa durante el proceso de subida.

*/


export default function AgregarDocumento() {
  // Estados para manejar la carga del formulario, la vista previa del Libro y los datos del formulario.  
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.tema.trim()) {  // Verifica que la descripcion esté vacío.  
  ...
  return (
    <div className="flex flex-wrap bg-gray-100 space-y-6 rounded-lg justify-between px-10 items-center">
      ...
      <div className="Intrucciones__agregar p-6 rounded-lg flex grow flex-col w-2/4 justify-center items-center space-y-4">
        <p className="text-lg font-semibold text-gray-800 mb-4">En esta sección podrás subir tus Libros de manera sencilla...</p>
        {/* Lista de pasos */}
        <ol className="space-y-4 text-gray-700">
          {/* Paso 1: Seleccionar Libro */}
          <li className="bg-white p-4 rounded-md shadow-sm">
            <h3 className="font-bold text-blue-600 mb-2">1. Selecciona tu Libro.</h3>
            <ul className="list-disc list-inside pl-4 space-y-1">
              ...
              <li>Si es un Libro local selecciona la opción correspondiente y sube el archivo:</li>
          ...
          <li className="bg-white p-4 rounded-md shadow-sm">
            ...
            <ul className="list-disc list-inside pl-4 space-y-1">
              ...
              <li>Selecciona el tema al que corresponda el Libro</li>
              <li>Agrega una descripción</li>
              <li>Agrega las categorías. Estas permitiran al buscador encontrar el Libro</li>
            </ul>
          </li>
          ...
          <li className="bg-white p-4 rounded-md shadow-sm">
            ...
            <ul className="list-disc list-inside pl-4 space-y-1">
              ...
              <li>Verifica la calidad del Libro</li>
              <li>Comprueba que cumple con los requisitos técnicos</li>
            </ul>
          </li>
        </ol>
        <p className="mt-6 text-green-700 font-medium">¡Listo! Haz clic en "Subir Libro" para compartir tu contenido.</p>
      </div>

      {/* Formulario para subir el Libro */}
