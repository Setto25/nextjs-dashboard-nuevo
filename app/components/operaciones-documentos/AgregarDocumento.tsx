...
export default function AgregarDocumento() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (formData.documentoArchivo) {  // Si hay un archivo de documento, lo agrega al FormData.  
      ...
      toast.error(error instanceof Error ? error.message : 'Error al agregar documento');  // Muestra un mensaje de error.  
    } finally {
  ...
  return (
    <div className="flex flex-wrap bg-gray-100 space-y-6 rounded-lg justify-between px-10 items-center">
      ...
      <div className="Intrucciones__agregar p-6 rounded-lg flex grow flex-col w-2/4 justify-center items-center space-y-4">
        <p className="text-lg font-semibold text-gray-800 mb-4">En esta sección podrás subir tus documentos de manera sencilla...</p>
        {/* Lista de pasos */}
        <ol className="space-y-4 text-gray-700">
          {/* Paso 1: Seleccionar documento */}
          <li className="bg-white p-4 rounded-md shadow-sm">
            <h3 className="font-bold text-blue-600 mb-2">1. Selecciona tu documento.</h3>
            <ul className="list-disc list-inside pl-4 space-y-1">
              ...
              <li>Si es un documento local selecciona la opción correspondiente y sube el archivo:</li>
          ...
          <li className="bg-white p-4 rounded-md shadow-sm">
            ...
            <ul className="list-disc list-inside pl-4 space-y-1">
              ...
              <li>Agrega las categorías. Estas permitiran al buscador encontrar el documento</li>
            </ul>
          </li>
        ...
        <p className="mt-6 text-green-700 font-medium">¡Listo! Haz clic en "Subir documento" para compartir tu contenido.</p>
      </div>
      ...
      <div className="Formulario__agregar rounded-lg justify-center items-center flex flex-col space-y-4">
        <h1 className="text-2xl font-bold mb-4 text-center">Agregar Nuevo documento</h1>
