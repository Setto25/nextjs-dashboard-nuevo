...
import AutoControlSemanalStock from '@/app/components/operaciones-insumos/AutoControlSemanalStock';
import { PackageOpen, ArrowRightLeft, Boxes } from 'lucide-react';
...
export default function Page() {
  const misTabs = [
    ...
    { name: 'Ajuste Automático de Stock', icon: <Boxes className="w-5 h-5 mx-auto" />, component: AutoControlSemanalStock }
  ];
